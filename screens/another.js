    ...
    <View className="flex-1">
      <SafeAreaView>
        <View className="w-full flex-row items-center justify-between px-4 py-10">
          ...
          <Text className="pl-12 self-center justify-center font-semibold">Home</Text>
          <TouchableOpacity className="flex items-center justify-center border-primary">
            <Text>Welcome: <Text className="font-extrabold">{profileName}</Text></Text>
          </TouchableOpacity>
        </View>
...
<Text className="text-primaryText text-base font-extrabold pb-2">Recent Chats</Text>
...
{chats && chats?.length>0?(
  ...
  <>
    <View className="w-full flex-row items-center justify-center py-4">
      <Text className="text-primaryText text-base font-extrabold">No Chats Available</Text>
    </View>
  </>
)
  }
...
{/*images*/}
<Image source={ChatPlus} className="h-12 w-12 rounded-full" />

<View className="flex-1 flex items-start justify-center ml-4 ">
<Text className="text-base text-[#333] font-semibold capitalize">{chat.chatName}</Text>
